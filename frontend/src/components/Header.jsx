...
const Header = () => {
  ...
  return (
    <header className="bg-gray-900 text-white py-0 px-3 sticky top-0 z-10">
              ...
              >
                ...
                <div>
                  <svg
                    ...
                    className={`h-5 w-5 transform transition-transform  ${isMenuOpen ? 'rotate-180' : 'rotate-0'
      ...
      <div
        className={`md:hidden top-14 left-0 right-0 bg-gray-900 ${isMenuOpen ? 'menu-open' : 'opacity-0 transform scale-y-0'
